-- Microsoft SQL Server compatible schema
-- Use this if connecting to SQL Server instead of SQLite

IF OBJECT_ID('signals', 'U') IS NOT NULL
    DROP TABLE signals;

IF OBJECT_ID('positions', 'U') IS NOT NULL
    DROP TABLE positions;

IF OBJECT_ID('user_api_keys', 'U') IS NOT NULL
